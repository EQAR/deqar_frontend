...
import style from "./FormManyESCOField.module.css";
import FormESCOField from "./FormESCOField";

const FormManyESCOField = ({disabled, scopeName, data, field, label, extra=1, required=false, addButtonText='Add More...', formApi, validate, placeholder, ...props}) => {
...
export default FormManyESCOField;
