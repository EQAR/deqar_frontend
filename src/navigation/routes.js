...
const routes = [
  ...
  { path: '/institutions/:param', exact: true, name: 'Institution Form', component: InstitutionDetails},
  { path: '/institutions/:param/:id', exact: true, name: 'Institution Form', component: InstitutionDetails},
